...
export default defineConfig({
  ...
  entryPoints: [
    ...
    'src/move-zero.ts',
    'src/move-zero.test.ts',
    'src/continuous-char.ts',
    'src/continuous-char.test.ts',
    'src/quick-sort.ts',
    'src/quick-sort.test.ts',
    'src/palindrome-number.ts',
    'src/palindrome-number.test.ts',
    'src/thousands-format.ts',
    'src/thousands-format.test.ts',
    'src/switch-case.ts',
    'src/switch-case.test.ts',
  ],
  format: ['cjs'],
  dts: false,
});
